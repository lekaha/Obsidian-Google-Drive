...
**Goals:**
- Eliminate dependency on `ogd.richardxiong.com` for desktop authentication
...
→ Users with old refresh tokens from `ogd.richardxiong.com` must re-authenticate. This is a breaking change but simplifies the implementation significantly.
